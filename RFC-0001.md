...
The goal is to provide a consistent mechanism across agentic coding tools while reducing token consumption, improving retrieval quality, reducing context pollution, and preventing irrelevant files from being included in normal agent context.
